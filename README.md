...
| `SECURITY_PATH_DATABASE`          | String    | /app/data/my-data.db      | Path and SQL-Lite database name used for storing the users credentials         |   
...
| `API_RATE_LIMITER_L1`             | String    | 60:10                     | Rate limiter setup: 60 seconds  max requests 10                                |    
| `API_RATE_LIMITER_L2`             | String    | 60:120                    | Rate limiter setup: 60 seconds  max requests 120                               |   
| `API_RATE_LIMITER_L3`             | String    | 60:300                    | Rate limiter setup: 60 seconds  max requests 300                               |   
| `API_RATE_LIMITER_L4`             | String    | 60:500                    | Rate limiter setup: 60 seconds  max requests 500                               |   
| `API_RATE_LIMITER_L5`             | String    | 60:1000                   | Rate limiter setup: 60 seconds  max requests 1000                              |   
