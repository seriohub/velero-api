...
RESOURCES: Dict[ResourcesNames, Resource] = {
    ...
    ResourcesNames.DELETE_BACKUP_REQUEST: Resource("Delete Backup Request", "DeleteBackupRequest",
                                                   "deletebackuprequests"),
    ...
    ResourcesNames.BACKUP_STORAGE_LOCATION: Resource("Backup Storage Location", "BackupStorageLocation",
                                                     "backupstoragelocations"),
    ResourcesNames.VOLUME_SNAPSHOT_LOCATION: Resource("Volume Snapshot Location", "VolumeSnapshotLocation",
                                                      "volumesnapshotlocations"),
    ResourcesNames.SERVER_STATUS_REQUEST: Resource("Server Status Request", "ServerStatusRequest",
                                                   "serverstatusrequests"),
}
